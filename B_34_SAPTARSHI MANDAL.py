...
def get_batch():
    with open(f'C:/Users/sapta/.spyder-py3','r') as f:
        reader=csv.reader(f)
...
def remove(string):
    with open(f'C:/Users/sapta/.spyder-py3','r+',newline='') as f:
        script=csv.reader(f)
...
def department_graph():
    need={}
    with open('C:/Users/sapta/.spyder-py3/Batch.csv','r') as f:
        reader=csv.reader(f)
        ...
        with open('C:/Users/sapta/.spyder-py3/Batch.csv','r') as f:
            ...
            for i in range(len(rows)):
                if arg==rows[i][0]:
                    ...
                    break
        req_lst=req.split(':')
        with open('C:/Users/sapta/.spyder-py3/Course.csv','r') as f:
            reader=csv.reader(f)
            rows=[row for row in reader]
            column=[]
            for i in range(len(rows)):
